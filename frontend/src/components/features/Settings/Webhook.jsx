...
const TeamPage = () => {
  ...
  useEffect(() => {
    fetchFromAPI('/api/retrieve_webhooks/', setWebhooks)
  }, [])

  function submit(){
    fetch(`${process.env.REACT_APP_API_URL}/api/update_webhook/`, {
        method: 'PUT',
        headers: {
        ...
        <Stack spacing={1}>
            ...
            <Stack spacing={1}>
                <Grid container>
                    ...
                    <Grid item xs={6}>
                        <Stack spacing={1}>
                            <Typography variant='subtitle1'>Select Campaign</Typography>
                            <Box
                            sx={{
                            ...
                            >
                                <Typography sx={{px: 2, py: 1.5}}>{currentCampaign.name || 'Campaign'}</Typography>
                            </Box>
                        </Stack>
                    </Grid>
                </Grid>
