...
const Performances = () => {
  ...
  useEffect(() => {
    fetchFromAPI('/api/full_report/', setData)
  }, [])
                    ...
                    <Grid item xs={1.5}>
                        <Stack spacing={0.5} direction='row'>
                            ...
                            <Stack spacing={0.5}>
                                ...
                                <Typography variant='subtitle2' sx={{fontWeight: 600}}>{data.open}</Typography>
                            </Stack>
                        </Stack>
                    </Grid>
                    <Grid item xs={5} sx={{display: 'flex', justifyContent: 'flex-start'}}>
                        <Stack spacing={0.5} direction='row'>
                            ...
                            <Stack spacing={0.5}>
                                ...
                                <Typography variant='subtitle2' sx={{fontWeight: 600}}>{data.replied}</Typography>
                            </Stack>
                        </Stack>
                    </Grid>
                </Grid>
